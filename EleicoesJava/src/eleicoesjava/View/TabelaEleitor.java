...
public class TabelaEleitor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        TbEleitor.setBackground(new java.awt.Color(255, 255, 255));
        ...
        if (TbEleitor.getColumnModel().getColumnCount() > 0) {
            ...
            TbEleitor.getColumnModel().getColumn(3).setResizable(false);
            TbEleitor.getColumnModel().getColumn(4).setResizable(false);
            TbEleitor.getColumnModel().getColumn(5).setResizable(false);
        }
        ...
        jLabel2.setText("Tabela de Eleitores");
